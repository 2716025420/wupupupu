...
//        EnvironmentVariableCredentialsProvider credentialsProvider = CredentialsProviderFactory.newEnvironmentVariableCredentialsProvider();
    ...
    private static final String bucketName = "wsh-event";
    // 填写Object完整路径，完整路径中不能包含Bucket名称，例如exampledir/exampleobject.txt。
    private static final String ACCESSKEY_ID = "LTAI5tRSUadPJqb4Pbuk7hKa";
    private static final String ACCESSKEY_SECRET = "wFzAoGU1TLlKUcTxMTVEm3zTcjHRLm";
    ...
    public static String upload(String objectName, InputStream in) throws Exception {
        ...
        try {
            ...
            url = "https://wsh-event.oss-cn-beijing.aliyuncs.com/" + objectName;
